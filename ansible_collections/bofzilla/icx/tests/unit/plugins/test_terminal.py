...
def test_terminal_prompt_allows_spaces():
	for output in (b"\r\nICX6450-48P Router#", b"\r\nICX6450-48P Router(config)#"):
		assert any(regex.search(output) for regex in TerminalModule.terminal_stdout_re)
